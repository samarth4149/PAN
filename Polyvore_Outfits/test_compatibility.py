    ...
    with tf.Session() as sess:
        ...
        for outfit in dl.comp_outfits:
            ...
            new_feed_dict = construct_feed_dict(placeholders, new_features, new_support,
                                        train_labels, None, query_r, query_c, 0., is_train=BN_AS_TRAIN, edge_c=False)
            #new_features: test_features

            pred = sess.run(model.outputs, feed_dict=new_feed_dict)
...
if __name__ == "__main__":
    ...
    parser.add_argument('-resampled','--resampled',default = False, help='whether use resampled testing')
